...
class _PcMedicalRecordsWidgetState extends State<PcMedicalRecordsWidget> {
  late PcMedicalRecordsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PcMedicalRecordsModel());
  }
