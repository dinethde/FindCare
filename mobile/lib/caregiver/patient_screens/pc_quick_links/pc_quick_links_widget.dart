...
class _PcQuickLinksWidgetState extends State<PcQuickLinksWidget> {
  late PcQuickLinksModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PcQuickLinksModel());
  }
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                      PcMedicalRecordsWidget.routeName);
                                },
                                child: wrapWithModel(
