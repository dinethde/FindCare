...
import 'pc_personalinfo_model.dart';
export 'pc_personalinfo_model.dart';
...
class _PcPersonalinfoWidgetState extends State<PcPersonalinfoWidget> {
  late PcPersonalinfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PcPersonalinfoModel());
  }
