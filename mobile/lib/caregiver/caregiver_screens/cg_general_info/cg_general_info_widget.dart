...
import 'cg_general_info_model.dart';
export 'cg_general_info_model.dart';
...
class _CgGeneralInfoWidgetState extends State<CgGeneralInfoWidget> {
  late CgGeneralInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CgGeneralInfoModel());
  }
