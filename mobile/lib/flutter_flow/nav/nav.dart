...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: MarcketPlace1Widget.routeName,
          path: MarcketPlace1Widget.routePath,
          builder: (context, params) => MarcketPlace1Widget(),
        ),
        FFRoute(
          name: MarcketPlace1CopyWidget.routeName,
          path: MarcketPlace1CopyWidget.routePath,
          builder: (context, params) => MarcketPlace1CopyWidget(),
        ),
        FFRoute(
          name: MarketPlace2Widget.routeName,
          path: MarketPlace2Widget.routePath,
