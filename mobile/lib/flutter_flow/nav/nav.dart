...
class AppStateNotifier extends ChangeNotifier {
  ...
  FindCareAuthUser? initialUser;
  FindCareAuthUser? user;
  ...
  void update(FindCareAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? HomePageWidget() : WelcomeScreenWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: PcPatientReportsWidget.routeName,
          path: PcPatientReportsWidget.routePath,
          builder: (context, params) => PcPatientReportsWidget(),
        )
