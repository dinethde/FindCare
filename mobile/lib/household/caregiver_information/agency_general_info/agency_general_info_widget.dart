...
import 'agency_general_info_model.dart';
export 'agency_general_info_model.dart';
...
class _AgencyGeneralInfoWidgetState extends State<AgencyGeneralInfoWidget> {
  late AgencyGeneralInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgencyGeneralInfoModel());
  }
