...
import 'rate_care_giver_screen_model.dart';
export 'rate_care_giver_screen_model.dart';
...
class _RateCareGiverScreenWidgetState extends State<RateCareGiverScreenWidget> {
  late RateCareGiverScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RateCareGiverScreenModel());
  }
