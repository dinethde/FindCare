...
class _PatientReportsWidgetState extends State<PatientReportsWidget> {
  late PatientReportsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PatientReportsModel());
  }
