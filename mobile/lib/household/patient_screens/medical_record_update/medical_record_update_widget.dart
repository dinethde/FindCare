...
class _MedicalRecordUpdateWidgetState extends State<MedicalRecordUpdateWidget> {
  late MedicalRecordUpdateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MedicalRecordUpdateModel());
