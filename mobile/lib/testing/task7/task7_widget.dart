...
import 'task7_model.dart';
export 'task7_model.dart';

class Task7Widget extends StatefulWidget {
  const Task7Widget({
    super.key,
    String? image,
    String? findcare,
  ...
  @override
  State<Task7Widget> createState() => _Task7WidgetState();
}

class _Task7WidgetState extends State<Task7Widget> {
  late Task7Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Task7Model());
  }
