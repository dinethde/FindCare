        ...
        <div className="flex gap-6">
            ...
            <div className="w-60 space-y-6">
                ...
                <ChartCard
                    ...
                    subtitle="This Week"
                    data={[
                        { name: "Successful", value: shiftStats.successful, color: "#007aff" },
                        { name: "Late", value: shiftStats.late, color: "#fca827" },
                        { name: "Cancelled", value: shiftStats.cancelled, color: "#ff2d55" },
                    ]}
                    centerText={shiftStats.total}
                    legend={{
                        items: [
                            { label: "successful shifts", value: shiftStats.successful, color: "#007aff" },
                            { label: "late shifts", value: shiftStats.late, color: "#fca827" },
                            { label: "cancelled shifts", value: shiftStats.cancelled, color: "#ff2d55" },
                        ],
                    }}
                />
                ...
                <ChartCard
                    ...
                    data={[
                        ...
                        { name: "Remaining", value: taskStats.total - taskStats.completed, color: "#f2f2f2" },
                    ]}
