 ...
 * Calendar component
 *
 * Renders a weekly calendar view, showing appointments across the week.
 *
 * @param {CalendarProps} props - The component props
 * @param {WeekData<CaregiverDayData>} props.calendarData - The calendar data to display
...
import type { WeekData, CaregiverDayData } from "@/types/ScheduleType" // Import the missing type

interface CalendarProps {
    calendarData: WeekData<CaregiverDayData>
}

const TIME_COLUMN_WIDTH = 60 // pixels

export function Calendar({ calendarData }: CalendarProps) {
    ...
    return (
        <div className="bg-white border border-neutral-3 rounded-xl shadow-lg overflow-hidden shadow-[0px_0px_10px_-1px_rgba(0,_0,_0,_0.12)]">
            <CalendarHeader weekOf={calendarData.weekOf} days={calendarData.days} />
