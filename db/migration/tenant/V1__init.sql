...
CREATE TABLE IF NOT EXISTS Tenant_Account (
                                              tenant_account_id SERIAL PRIMARY KEY,
...
CREATE TABLE Agency (
                        ...
                        tenant_account_id INTEGER NOT NULL,
                        FOREIGN KEY (tenant_account_id) REFERENCES Tenant_Account(tenant_account_id) ON DELETE CASCADE
);
